...
class UpdateOrganizationBloc {
  ...
  updateOrganization(id, email, phone1, phone2, whatsapp, address1, address2, address3, address4, customerTypeId) async {
    ...
    try {
      UpdateOrganization res = await _updateOrganizationRepository.updateOrganization(
          id, email, phone1, phone2, whatsapp, address1, address2, address3, address4, customerTypeId);
      if (_updateOrganizationController?.isClosed ?? true) return;
