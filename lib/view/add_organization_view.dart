...
class _AddOrganizationViewState extends State<AddOrganizationView> {
  ...
  calculateLatLngRange(double lat, double lon, double distanceInMeters) {
    ...
    double lonRange =
        distanceInKm / (earthRadius * (pi / 180) * cos(lat * pi / 180));
    ...
    _organizationBloc.getOrganizationByLocation(minLon.toString(),
        maxLon.toString(), minLat.toString(), maxLat.toString());
  }
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          if (organizationType == "Project")
                            _buildToggleSwitch('Waterproofing', isWaterproofing,
                                (value) {
                              setState(() {
                            ...
                            child: CommonAppButton(
                              ...
                              onPressed: () {
                                ...
                                _ownerNameController.text =
                                    capitalizeWords(_ownerNameController.text);
                                ...
                                _cityController.text =
                                    capitalizeWords(_cityController.text);
                                ...
                                if (_formKey.currentState!.validate() &&
                                  ...
                                  final name =
                                      "${_nameController.text}_${_cityController.text}";
                                  final email =
                                  ...
                                  final ownerName =
                                      _ownerNameController.text.toString();
                    ...
                    child: ToggleButtons(
                      ...
                      onPressed: (index) {
                        ...
                        setState(() {
                          ...
                          organizationType =
                              _allCustomerTypes![index].aebez.toString();
                          organizationColor =
  ...
  showNearbyOrganizationsPopup(
      BuildContext context, List<Organization> nearbyOrganizations) {
