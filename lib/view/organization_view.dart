  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: widget.isTeamMemberUi == false ||
              isDataViewer(widget.designationNummer) == false
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            String organizationNummer =
                                                organizations.orgnummer
                                                    .toString();
                                            String organizationName =
                                                organizations.namebspr
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationPhone1 =
                                                organizations.yphone1
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationPhone2 =
                                                organizations.yphone2
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationWhatsapp =
                                                organizations.ywhtapp
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationAddress1 =
                                                organizations.yaddressl1
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationAddress2 =
                                                organizations.yaddressl2
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationAddress3 =
                                                organizations.yaddressl3
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationAddress4 =
                                                organizations.yaddressl4
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            ...
                                            String organizationMail =
                                                organizations.yemail
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String ysuporgNummer = organizations
                                                    .ysuporgNummer
                                                    ?.toString() ??
                                                'Unnamed Route';
                                            String ysuporgNamebspr =
                                                organizations.ysuporgNamebspr
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String organizationTypeId =
                                                organizations.ycustypId
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            ...
                                            String organizationAssignTo =
                                                organizations.yassigto
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String ownerName = organizations
                                                    .yowname
                                                    ?.toString() ??
                                                'Unnamed Route';
                                            String isMasonry = organizations
                                                    .ymasonry
                                                    ?.toString() ??
                                                'Unnamed Route';
                                            String isWaterproofing =
                                                organizations.ywaterpr
                                                        ?.toString() ??
                                                    'Unnamed Route';
                                            String isFlooring = organizations
                                                    .yflooring
                                                    ?.toString() ??
                                                'Unnamed Route';
