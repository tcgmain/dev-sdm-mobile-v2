                      ...
                      ? Row(
                          ...
                          children: <Widget>[
                            ...
                            CustomIconButton(
                                ...
                                onPressed: () {
                                  _showCallOptions(context,widget.organizationPhone1,widget.organizationPhone2,widget.organizationWhatsapp);
                                })
                          ],
                        )
                      : Container(),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (widget.organizationPhone1.isEmpty && widget.organizationPhone2.isEmpty && widget.organizationWhatsapp.isEmpty)
                const Padding(
