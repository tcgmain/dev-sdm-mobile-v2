...
class _UpdateOrganizationViewState extends State<UpdateOrganizationView> {
  ...
  void initState() {
    ...
    _ownerNameController =
        TextEditingController(text: widget.ownerName.toString());
    _emailController =
                        ...
                        child: Column(
                          children: [
                            ...
                            if (organizationType == "Project" ||
                                organizationType == "(4147,12,0)")
                              _buildToggleSwitch(
                                  'Waterproofing', isWaterproofing, (value) {
                                setState(() {
                            ...
                            if (organizationType == "Project" ||
                                organizationType == "(4147,12,0)")
                              _buildToggleSwitch('Flooring', isFlooring,
                                  (value) {
                                setState(() {
                                  isFlooring = value;
                                });
                              ...
                              child: CommonAppButton(
                                ...
                                onPressed: () {
                                  if (!_isUpdatePressed) {
                                    ...
                                    _ownerNameController.text = capitalizeWords(
          ...
          switch (snapshot.data!.status!) {
            ...
            case Status.COMPLETED:
              ...
              if (!_isSuccessMessageShown) {
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  showSuccessAlertDialogUpdateOrganization(
  ...
  Future<void> showSuccessAlertDialogUpdateOrganization(
